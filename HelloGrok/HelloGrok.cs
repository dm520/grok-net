...
namespace HelloGrok
{
    public class HelloGrok
    {
        public static void RunHelloGrok()
        {
		    ...
		    try 
            {
			    ...
			    string ProjectName = "Recreation Center Test " + (new DateTime()).ToString();
			    ...
			    HelloGrokModel.name = "Hello Grok - Rec Center - " + DateTime.Now.ToString();
                ...
                Swarm swarm = HelloGrokModel.SwarmModel("medium");
			    ...
			    string OutputFile = "output/SwarmOutput.csv";
			    ...
			    Console.WriteLine("In Part 2 of this tutorial we will add data to "
					    + "our model in production ready status.");
			    Console.WriteLine("Please save the Model ID below in the Config file. "
					    + "You'll need it for Part 2!");

			    Console.WriteLine(HelloGrokModel.id);
